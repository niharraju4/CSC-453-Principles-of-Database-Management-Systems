...
--Find name of all customers in Illinois
...
--Find all customers whose last names start with letter 'B'

SELECT * 
FROM customers 
WHERE last_name LIKE 'B%';

--Find name of all customers that have order in 2018, sort them in increasing order of order_date
...
--Find all customers that have no order
...
--Find name of all customers that have orders with no shipped_date (i.e., shipped_data is NULL)
SELECT c.first_name || ' ' || c.last_name AS "Name"
FROM customers c
INNER JOIN orders o ON c.customer_id = o.customer_id
WHERE o.shipped_date IS NULL;

--Find all customers that order more than once, sort in increasing order of the total number of orders.

SELECT c.customer_id, COUNT(*) AS "Total number of  orders"
FROM customers c
INNER JOIN orders o ON c.customer_id = o.customer_id 
